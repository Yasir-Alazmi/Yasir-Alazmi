...
| :--- | :--- | :--- | :--- |
| **[enterprise-production-rag](https://github.com/Yasir-Alazmi/enterprise-production-rag)** | Enterprise RAG / Information Retrieval | Hybrid Search (BM25 + Dense RRF), Cross-Encoder, FastAPI, Docker | [![CI](https://github.com/Yasir-Alazmi/enterprise-production-rag/actions/workflows/ci.yml/badge.svg)](https://github.com/Yasir-Alazmi/enterprise-production-rag/actions) |
