...
| :--- | :--- | :--- | :--- |
| **[enterprise-production-rag](https://github.com/Yasir-Alazmi/enterprise-production-rag)** | Enterprise RAG Reference Architecture | Zero-Trust JWT Auth, Dual-Mode Embeddings, Hybrid Search (RRF), Pluggable LLM | [![CI](https://github.com/Yasir-Alazmi/enterprise-production-rag/actions/workflows/ci.yml/badge.svg)](https://github.com/Yasir-Alazmi/enterprise-production-rag/actions) |
